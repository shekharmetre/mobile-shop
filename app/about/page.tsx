                ...
                <div className="flex-col justify-start lg:items-start items-center gap-4 flex">
                  ...
                  <div className="w-full flex-col justify-start lg:items-start items-center gap-3 flex">
                    ...
                    <p
                      ...
                      Our journey is a true testament to perseverance, dedication, and a deep understanding of our customers' needs. For over 16 years, we've been at the forefront of the mobile services and accessories industry, delivering 100% quality products that ensure customer satisfaction</p>
                  </div>
                </div>
                <div className="w-full h-full justify-start items-center gap-8 grid md:grid-cols-2 grid-cols-1">
                  <div
                    className="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
                    <h4 className="text-gray-900 text-2xl font-bold font-manrope leading-9">16+ Years</h4>
                  ...
                  <div
                    ...
                    <h4 className="text-gray-900 text-2xl font-bold font-manrope leading-9">500+ Reviews</h4>
                    <p className="text-gray-500 text-base font-normal leading-relaxed">Genuine Feedback Reflecting Our Trusted Service</p>
                  </div>
                  <div
                    className="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
                  ...
                  <div
                    className="w-full h-full p-3.5 rounded-xl border border-gray-200 hover:border-gray-400 transition-all duration-700 ease-in-out flex-col justify-start items-start gap-2.5 inline-flex">
                    <h4 className="text-gray-900 text-2xl font-bold font-manrope leading-9">3+ Retail Stores</h4>
                    <p className="text-gray-500 text-base font-normal leading-relaxed">Physical Presence That Builds Local Trust & Instant Support.</p>
                  </div>
                </div>
              </div>
              <button
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-600 leading-relaxed">
              With over 15 years of experience in the mobile industry, John's vision has been
              to create a trusted platform where customers can find the latest smartphones
              with guaranteed authenticity and exceptional service.
            </p>
          </motion.div>
        </div>
      </section>
